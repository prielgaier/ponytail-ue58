...
name: ponytail
description: >
  Unreal Engine 5.0 minimal-engineering mode. Finds the smallest correct UE5.0
  ...
  Use on ANY UE5.0 C++, Blueprint, module, plugin, config, gameplay, networking,
  ...
  auto-apply to non-Unreal work or Unreal versions other than 5.0.
---
