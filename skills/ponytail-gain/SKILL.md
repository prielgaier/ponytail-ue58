...
name: ponytail-gain
description: >
  Produce an evidence-only Unreal Engine 5.6 simplification scoreboard from the
  ...
  /ponytail-gain, UE5.6 simplification impact, or what Ponytail changed. Never
...
```text
Ponytail UE5.6 gain — current diff only
