...
name: ponytail-gain
description: >
  Produce an evidence-only Unreal Engine 5.4 simplification scoreboard from the
  ...
  /ponytail-gain, UE5.4 simplification impact, or what Ponytail changed. Never
...
```text
Ponytail UE5.4 gain — current diff only
