...
name: ponytail-gain
description: >
  Produce an evidence-only Unreal Engine 5.3 simplification scoreboard from the
  ...
  /ponytail-gain, UE5.3 simplification impact, or what Ponytail changed. Never
...
```text
Ponytail UE5.3 gain — current diff only
