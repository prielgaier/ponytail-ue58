...
name: ponytail-gain
description: >
  Produce an evidence-only Unreal Engine 5.5 simplification scoreboard from the
  ...
  /ponytail-gain, UE5.5 simplification impact, or what Ponytail changed. Never
...
```text
Ponytail UE5.5 gain — current diff only
