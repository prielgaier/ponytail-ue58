...
name: ponytail-gain
description: >
  Produce an evidence-only Unreal Engine 5.0 simplification scoreboard from the
  ...
  /ponytail-gain, UE5.0 simplification impact, or what Ponytail changed. Never
...
```text
Ponytail UE5.0 gain — current diff only
