...
name: ponytail-gain
description: >
  Produce an evidence-only Unreal Engine 5.2 simplification scoreboard from the
  ...
  /ponytail-gain, UE5.2 simplification impact, or what Ponytail changed. Never
...
```text
Ponytail UE5.2 gain — current diff only
