#!/usr/bin/env node
// Ponytail UE4.27 MCP server: serves the Unreal-specific ruleset over stdio as a
...
server.registerPrompt(
  "ponytail",
  {
    title: "Ponytail UE4.27 mode",
    description: "UE4.27 instructions: inspect ownership, prefer native engine facilities, and make the smallest safe change.",
...
server.registerTool(
  ...
  {
    title: "Ponytail UE4.27 instructions",
    description: "Return the Ponytail UE4.27 ruleset for the given intensity (lite, full, or ultra).",
