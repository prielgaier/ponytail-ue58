#!/usr/bin/env node
// Ponytail UE5.4 MCP server: serves the Unreal-specific ruleset over stdio as a
...
server.registerPrompt(
  "ponytail",
  {
    title: "Ponytail UE5.4 mode",
    description: "UE5.4 instructions: inspect ownership, prefer native engine facilities, and make the smallest safe change.",
...
server.registerTool(
  ...
  {
    title: "Ponytail UE5.4 instructions",
    description: "Return the Ponytail UE5.4 ruleset for the given intensity (lite, full, or ultra).",
