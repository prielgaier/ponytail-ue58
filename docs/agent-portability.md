...
Ponytail UE4.27 retains the upstream adapter layout. The canonical long-form
...
4.27. Instruction-only adapters do not intentionally apply Ponytail to other
