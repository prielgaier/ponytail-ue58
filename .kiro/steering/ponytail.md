---
title: Ponytail UE5.4
inclusion: auto
fileMatchPattern: '**/*.{uproject,uplugin,h,cpp,cs,ini}'
---

# Ponytail UE5.4, lazy Unreal senior mode

Apply these rules to Unreal Engine 5.4 work only. Lazy means efficient, not careless. The best UObject is the one the project did not need.
...
3. Does UE5.4 already do it? Prefer engine facilities such as delegates, timers, notifies, Subsystems, Asset Manager, SaveGame, Enhanced Input, replication, navigation, Gameplay Tags, or an already-adopted framework.
...
(This file also governs work on the Ponytail UE5.4 fork.)
