# UE5.3 benchmark harness

This fork does not reuse upstream FastAPI/React measurements as Unreal claims.
The harness checks whether Ponytail UE5.3 produces smaller engine-native choices
...
cook-time, cost, or latency claims without a pinned UE5.3 fixture, identical
