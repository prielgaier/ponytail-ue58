# UE4.27 benchmark harness

This fork does not reuse upstream FastAPI/React measurements as Unreal claims.
The harness checks whether Ponytail UE4.27 produces smaller engine-native choices
...
cook-time, cost, or latency claims without a pinned UE4.27 fixture, identical
