<p align="center">
  <img src="assets/logo.png" alt="Ponytail UE4.27" width="180">
</p>
...
This is an Unreal Engine 4.27-specific fork of
...
[VERSIONS.md](VERSIONS.md) for the UE4.27 and UE4.0-UE4.27 branch matrix.
...
3. Does UE4.27 already provide the lifecycle or system?
...
Ponytail UE4.27 never minimizes away:
...
| `/ponytail-audit` | Audit the entire UE4.27 project. |
...
Those rules are UE4.27-scoped and do not ask agents to apply Ponytail to
non-Unreal tasks.
...
for Unreal Engine. This fork ships UE4.27-specific behavioral and structural
gates, but publishes no FPS, memory, package-size, cook-time, code-size, token,
cost, or latency claims until they are measured on reproducible UE4.27 fixtures.
...
UE4.27 conversion maintained at
