<p align="center">
  <img src="assets/logo.png" alt="Ponytail UE5.3" width="180">
</p>
...
This is an Unreal Engine 5.3-specific fork of
...
[VERSIONS.md](VERSIONS.md) for the UE4.27 and UE5.0-UE5.3 branch matrix.
...
3. Does UE5.3 already provide the lifecycle or system?
...
Ponytail UE5.3 never minimizes away:
...
| `/ponytail-review` | Review the current UE5.3 diff for removable complexity. |
| `/ponytail-audit` | Audit the entire UE5.3 project. |
...
Those rules are UE5.3-scoped and do not ask agents to apply Ponytail to
non-Unreal tasks.
...
for Unreal Engine. This fork ships UE5.3-specific behavioral and structural
gates, but publishes no FPS, memory, package-size, cook-time, code-size, token,
cost, or latency claims until they are measured on reproducible UE5.3 fixtures.
...
UE5.3 conversion maintained at
