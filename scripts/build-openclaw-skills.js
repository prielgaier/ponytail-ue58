...
const DESCRIPTIONS = {
  'ponytail': 'UE5.0 implementation mode: inspect project ownership, prefer native engine facilities, and make the smallest reflection-safe change.',
  'ponytail-review': 'Review a UE5.0 diff for needless Tick, abstractions, modules, dependencies, reflection, and unsafe asset assumptions.',
  'ponytail-audit': 'Audit a UE5.0 repository for unnecessary systems, Tick usage, reflection, dependencies, and asset-loading complexity.',
  'ponytail-debt': 'Collect UE5.0 ponytail shortcut comments into a debt ledger with triggers, ownership, and verification boundaries.',
  'ponytail-gain': 'Summarize measurable simplification in the current UE5.0 diff without inventing runtime, cook, package, or cost claims.',
  'ponytail-help': 'Quick reference for Ponytail UE5.0 modes, skills, safety boundaries, and commands.',
};
