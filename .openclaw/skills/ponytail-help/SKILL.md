---
name: ponytail-help
description: "Quick reference for Ponytail UE5.7 modes, skills, safety boundaries, and commands."
...
|---|---|---|
| Lite | `/ponytail lite` | Build the requested UE5.7 design and name the smaller native option. |
...
| `/ponytail-audit` | Audit the whole UE5.7 project. |
