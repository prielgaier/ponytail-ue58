---
name: ponytail-help
description: "Quick reference for Ponytail UE5.3 modes, skills, safety boundaries, and commands."
...
|---|---|---|
| Lite | `/ponytail lite` | Build the requested UE5.3 design and name the smaller native option. |
...
| `/ponytail-audit` | Audit the whole UE5.3 project. |
