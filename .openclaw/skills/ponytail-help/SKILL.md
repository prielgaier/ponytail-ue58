---
name: ponytail-help
description: "Quick reference for Ponytail UE5.1 modes, skills, safety boundaries, and commands."
...
|---|---|---|
| Lite | `/ponytail lite` | Build the requested UE5.1 design and name the smaller native option. |
...
| `/ponytail-audit` | Audit the whole UE5.1 project. |
